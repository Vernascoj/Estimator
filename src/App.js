      ...
      <Dialog open={settingsOpen} onOpenChange={setSettingsOpen}>
        ...
        <DialogContent className="sm:max-w-md">
          ...
          <div className="grid grid-cols-2 gap-4 py-4">
            ...
            <Input id="driveRate" type="number" step="0.01" value={driveRate} onChange={e => setDriveRate(parseFloat(e.target.value) || 0)} />
            <Label htmlFor="expensePct">Avg Expense (%)</Label>
            <Input id="expensePct" type="number" step="0.1" value={expensePct} onChange={e => setExpensePct(parseFloat(e.target.value) || 0)} />
            <Label htmlFor="payrollPct">Payroll Burden (%)</Label>
            <Input id="payrollPct" type="number" step="0.1" value={payrollPct} onChange={e => setPayrollPct(parseFloat(e.target.value) || 0)} />
          </div>
...
// ... rest of components and App function with relative imports unchanged ...
